                ...
                <div style="background: white; border-radius: 15px; box-shadow: 0 5px 20px rgba(0,0,0,0.05); overflow: hidden; border: 1px solid #e9ecef;">
                    ...
                    <div style="background: #f8fafc; padding: 20px 25px; border-bottom: 1px solid #e9ecef;">
                        <h3 style="color: #333; margin: 0; font-size: 1.3em; font-weight: 600;">
                            <i class="fa fa-user-edit" style="color: #2c5f2d; margin-right: 10px;"></i>
                            Edit User: <?php echo isset($userInfo->name) ? $userInfo->name : ''; ?>
                        </h3>
                            ...
                            <div style="margin-bottom: 30px;">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div style="margin-bottom: 20px;">
                                            <label style="display: block; margin-bottom: 8px; color: #495057; font-weight: 500;">
                                                Password <small style="color: #6c757d; font-weight: normal;">(Leave blank to keep current)</small>
                                            </label>
                                            <div style="position: relative;">
                                                ...
                                                <select class="form-control required" id="role" name="role" required
                                                    ...
                                                    if(!empty($roles))
                                                    {
                                                        foreach ($roles as $rl)
                                                        {
                                                            ...
                                                            $selected = (isset($userInfo->roleId) && $userInfo->roleId == $rl->roleId) ? 'selected' : '';
                                                            ?>
                                        ...
                                        <div style="margin-bottom: 20px;">
                                            ...
                                            <div style="position: relative;">
                                                ...
                                                <select class="form-control" id="isAdmin" name="isAdmin"
                                                        ...
                                                        onfocus="this.style.borderColor='#2c5f2d'; this.style.boxShadow='0 0 0 3px rgba(44,95,45,0.1)'"
                                                        onblur="this.style.borderColor='#ced4da'; this.style.boxShadow='none'">
                                                    <option value="2" <?php echo (isset($userInfo->isAdmin) && $userInfo->isAdmin == 2) ? 'selected' : ''; ?> style="color: #495057;">Regular User</option>
                                                    <option value="1" <?php echo (isset($userInfo->isAdmin) && $userInfo->isAdmin == 1) ? 'selected' : ''; ?> style="color: #495057;">System Administrator</option>
                                                </select>
                                                <i class="fa fa-chevron-down" style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); color: #adb5bd; pointer-events: none;"></i>
                                            </div>
                                        </div>
                                        ...
                                        <div style="display: flex; align-items: center; gap: 30px; flex-wrap: wrap;">
                                            ...
                                            <div style="text-align: center;">
                                                ...
                                                <div id="imagePreview" style="width: 150px; height: 150px; border-radius: 50%; background: #f8f9fa; border: 3px solid <?php echo isset($userInfo->profile_image) && !empty($userInfo->profile_image) ? '#2c5f2d' : '#ced4da'; ?>; display: flex; align-items: center; justify-content: center; overflow: hidden; margin-bottom: 10px; position: relative;">
                                                    <img id="previewImg" src="<?php echo $profileImage; ?>" alt="Profile Preview" style="width: 100%; height: 100%; object-fit: cover; display: block;">
                                            ...
                                            <div style="flex: 1;">
                                                <div style="margin-bottom: 15px;">
                                                    ...
                                                    <span id="fileName" style="margin-left: 15px; color: #6c757d;">
                                                ...
                                                <div style="margin-top: 10px;">
                                                    <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                                                        ...
                                                        <span style="color: #dc3545;"><i class="fa fa-trash"></i> Remove current image</span>
                                                    </label>
                                                </div>
                                                <?php endif; ?>
                                        ...
                                        <div style="margin-bottom: 15px;">
                                            ...
                                            <div style="position: relative;">
                                                <select class="form-control" id="country" name="country"
                                                    ...
                                                    <option value="Ethiopia" <?php echo (isset($userInfo->country) && $userInfo->country == 'Ethiopia') ? 'selected' : ''; ?> style="color: #495057;">🇪🇹 Ethiopia</option>
                                                    <option value="Kenya" <?php echo (isset($userInfo->country) && $userInfo->country == 'Kenya') ? 'selected' : ''; ?> style="color: #495057;">🇰🇪 Kenya</option>
                                                    <option value="Uganda" <?php echo (isset($userInfo->country) && $userInfo->country == 'Uganda') ? 'selected' : ''; ?> style="color: #495057;">🇺🇬 Uganda</option>
                                                    <option value="Tanzania" <?php echo (isset($userInfo->country) && $userInfo->country == 'Tanzania') ? 'selected' : ''; ?> style="color: #495057;">🇹🇿 Tanzania</option>
                                                    <option value="Rwanda" <?php echo (isset($userInfo->country) && $userInfo->country == 'Rwanda') ? 'selected' : ''; ?> style="color: #495057;">🇷🇼 Rwanda</option>
                                                    <option value="South Africa" <?php echo (isset($userInfo->country) && $userInfo->country == 'South Africa') ? 'selected' : ''; ?> style="color: #495057;">🇿🇦 South Africa</option>
                                                    <option value="Nigeria" <?php echo (isset($userInfo->country) && $userInfo->country == 'Nigeria') ? 'selected' : ''; ?> style="color: #495057;">🇳🇬 Nigeria</option>
                                                    <option value="Ghana" <?php echo (isset($userInfo->country) && $userInfo->country == 'Ghana') ? 'selected' : ''; ?> style="color: #495057;">🇬🇭 Ghana</option>
                                                    <option value="Egypt" <?php echo (isset($userInfo->country) && $userInfo->country == 'Egypt') ? 'selected' : ''; ?> style="color: #495057;">🇪🇬 Egypt</option>
                                                    <option value="Sudan" <?php echo (isset($userInfo->country) && $userInfo->country == 'Sudan') ? 'selected' : ''; ?> style="color: #495057;">🇸🇩 Sudan</option>
                                                    <option value="Other" <?php echo (isset($userInfo->country) && $userInfo->country == 'Other') ? 'selected' : ''; ?> style="color: #495057;">🌍 Other</option>
                                                </select>
                                                <i class="fa fa-chevron-down" style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); color: #adb5bd; pointer-events: none;"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div style="margin-bottom: 15px;">
                                            ...
                                            <textarea class="form-control" id="expertise_area" name="expertise_area" 
                                                      ...
                                                      onfocus="this.style.borderColor='#2c5f2d'; this.style.boxShadow='0 0 0 3px rgba(44,95,45,0.1)'"
                                                      onblur="this.style.borderColor='#ced4da'; this.style.boxShadow='none'"><?php echo isset($userInfo->expertise_area) ? $userInfo->expertise_area : ''; ?></textarea>
                                            <small style="color: #6c757d; font-size: 0.8em; margin-top: 5px; display: block;">
                                    ...
                                    <div class="col-md-12">
                                        <div style="margin-bottom: 15px;">
                                            ...
                                            <textarea class="form-control" id="bio" name="bio" 
                                                      ...
                                                      style="padding: 12px 15px; border: 1px solid #ced4da; border-radius: 8px; width: 100%; font-size: 0.95em; transition: all 0.2s; background: #fff; resize: vertical;"
                                                      onfocus="this.style.borderColor='#2c5f2d'; this.style.boxShadow='0 0 0 3px rgba(44,95,45,0.1)'"
                                                      onblur="this.style.borderColor='#ced4da'; this.style.boxShadow='none'"><?php echo isset($userInfo->bio) ? $userInfo->bio : ''; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div style="background: white; border-radius: 12px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); overflow: hidden; border: 1px solid #e9ecef;">
                    <div style="background: #f8fafc; padding: 15px 20px; border-bottom: 1px solid #e9ecef;">
                        <h4 style="color: #333; margin: 0; font-size: 1.1em; font-weight: 600;">
                            <i class="fa fa-info-circle" style="color: #2c5f2d;"></i> Editing Tips
                        </h4>
                    </div>
                    <div style="padding: 20px;">
                        <div style="display: flex; gap: 12px; margin-bottom: 15px;">
                            <div style="background: #e8f0e8; width: 36px; height: 36px; border-radius: 8px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                                <i class="fa fa-key" style="color: #2c5f2d;"></i>
                            </div>
                            <div>
                                <h5 style="margin: 0 0 3px 0; color: #333; font-weight: 600; font-size: 0.95em;">Password</h5>
                        ...
                        <div style="display: flex; gap: 12px; margin-bottom: 15px;">
                            ...
                            <div>
                                <h5 style="margin: 0 0 3px 0; color: #333; font-weight: 600; font-size: 0.95em;">Profile Picture</h5>
                        ...
                        <div style="display: flex; gap: 12px;">
                            ...
                            <div>
                                ...
                                <p style="margin: 0; color: #6c757d; font-size: 0.85em;">Update research areas for reviewer matching</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        window.previewImage = function(input) {
            ...
            if (input.files && input.files[0]) {
                ...
                if (input.files[0].size > 2 * 1024 * 1024) {
                    ...
                    $('#profile_image').val('');
                    $('#previewImg').attr('src', '<?php echo $profileImage; ?>');
                    $('#fileName').text('<?php echo isset($userInfo->profile_image) && !empty($userInfo->profile_image) ? $userInfo->profile_image : 'No file chosen'; ?>');
                }
            } else {
                $('#previewImg').attr('src', '<?php echo $profileImage; ?>');
                if('<?php echo isset($userInfo->profile_image) && !empty($userInfo->profile_image); ?>') {
                    $('#imagePreview').css('border', '3px solid #2c5f2d');
                } else {
