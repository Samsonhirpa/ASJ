...
<table class="table table-striped table-bordered">
    <thead><tr><th>Manuscript #</th><th>Title</th><th>Subject</th><th>Thematic Area</th><th>Keywords</th><th>Action</th></tr></thead>
    <tbody>
    ...
    <?php endforeach; else: ?>
        <tr><td colspan="6" class="text-center">No accepted manuscripts found.</td></tr>
    <?php endif; ?>
    </tbody>
</table>
</div></div></section></div>
