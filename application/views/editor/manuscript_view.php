                ...
                <div class="box box-default">
                    ...
                    <div class="box-body table-responsive">
                        <table class="table table-condensed">
                            <thead><tr><th>Reviewer</th><th>Status</th><th>Due</th></tr></thead>
                            <tbody>
                            <?php if (!empty($assignments)): foreach ($assignments as $a): ?>
                                <tr><td><?= html_escape($a->reviewerName) ?></td><td><?= html_escape($a->status) ?></td><td><?= html_escape($a->reviewDueDate) ?></td></tr>
                            <?php endforeach; else: ?>
