  ...
  <section class="content">
    <div class="box box-primary">
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <form method="post" action="<?= base_url('editor/production-stage/save/' . (int)$manuscript->manuscriptId) ?>">
              ...
              <button class="btn btn-primary btn-sm" name="action" value="send_typesetting">Save & Send to Typesetting</button>
            </form>
          </div>
          <div class="col-md-4">
            <h4>Typesetting</h4>
            <form method="post" action="<?= base_url('editor/production-stage/save/' . (int)$manuscript->manuscriptId) ?>">
              ...
              <input name="page_numbers" class="form-control" placeholder="Page numbers" value="<?= html_escape($manuscript->page_numbers ?? '') ?>"><br>
              ...
              <button class="btn btn-warning btn-sm" name="action" value="send_proof">Save & Send Proof</button>
            </form>
          </div>
          <div class="col-md-4">
            ...
            <form method="post" action="<?= base_url('editor/production-stage/save/' . (int)$manuscript->manuscriptId) ?>">
              ...
              <textarea class="form-control" name="final_abstract" rows="3" placeholder="Final abstract"><?= html_escape($manuscript->final_abstract ?? '') ?></textarea><br>
              ...
              <input class="form-control" name="final_orcid_ids" placeholder="Final ORCID IDs" value="<?= html_escape($manuscript->final_orcid_ids ?? '') ?>"><br>
      ...
      <div class="box-footer">
        <a href="<?= base_url('publisher/pending-production') ?>" class="btn btn-default">Back to Pending Production</a>
      </div>
    </div>
  </section>
</div>
