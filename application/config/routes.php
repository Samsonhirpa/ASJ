...
$route['editor/assignments/approve/(:num)'] = 'editor/manuscript/approveReviewerResult/$1';
$route['editor/assignments/rereview/(:num)'] = 'editor/manuscript/requestReReview/$1';
